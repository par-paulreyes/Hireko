...
namespace Hireko.Forms
{
    public partial class CreateServiceForm : Form
    {
        ...
        private void bntCreateService_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = @"INSERT INTO Services (Category, Occupation, Description, ExperienceLevel, EducationalBackground, Price) 
                                 VALUES (@Category, @Occupation, @Description, @ExperienceLevel, @EducationalBackground, @Price)";
